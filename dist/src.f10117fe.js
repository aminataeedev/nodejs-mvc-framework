...
var Model = /*#__PURE__*/_createClass(function Model(eventing, sync, attributes) {
  var _this = this;
  ...
  this.get = function (propName) {
    return _this.attributes.get(propName);
  };
  this.getData = function () {
    return _this.attributes.getData();
  };
  this.set = function (_props) {
    _this.attributes.set(_props);
    _this.eventing.trigger("set");
  };
  this.on = this.eventing.on;
  this.trigger = this.eventing.trigger;
  this.fetch = this.sync.fetch;
  this.save = function () {
    return _this.sync.save(_this.getData()).then(function (response) {
      _this.trigger("save");
    }).catch(function () {
...
var Eventing = /*#__PURE__*/_createClass(function Eventing() {
  ...
  this.on = function (eventName, callback) {
    var eventIndex = _this.events.findIndex(function (event) {
      return event.name === eventName;
    });
    if (eventIndex > -1) _this.events[eventIndex].callbacks = [].concat(_toConsumableArray(_this.events[eventIndex].callbacks), [callback]);else _this.events.push({
      name: eventName,
      callbacks: [callback]
    });
  };
  this.trigger = function (eventName) {
    ...
    if (eventIndex > -1) _this.events[eventIndex].callbacks.forEach(function (callback) {
      callback();
    });
  };
});
...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/utils/axios.ts":[function(require,module,exports) {
"use strict";
...
exports.AxiosCRUD = void 0;
var axios_1 = __importDefault(require("axios"));
var AxiosCRUD = /*#__PURE__*/function () {
  function AxiosCRUD() {
    _classCallCheck(this, AxiosCRUD);
  }
  _createClass(AxiosCRUD, null, [{
    key: "get",
      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios_1.default.get(request.url, {
    ...
    value: function post(request) {
      return axios_1.default.post(request.url, request.params);
    }
  }, {
    key: "put",
    value: function put(request) {
      return axios_1.default.put(request.url, request.params);
    }
  }]);
  return AxiosCRUD;
}();
exports.AxiosCRUD = AxiosCRUD;
},{"axios":"node_modules/axios/index.js"}],"src/Models/Sync.ts":[function(require,module,exports) {
"use strict";
...
var Sync = /*#__PURE__*/_createClass(function Sync(baseURL) {
  var _this = this;
  ...
  this.fetch = function (id) {
    return __awaiter(_this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", axios_1.AxiosCRUD.get({
              url: this.baseURL,
              params: {
                id: id
              }
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", axios_1.AxiosCRUD.put({
              url: this.baseURL + "/".concat(data.id),
              params: data
            }));
          case 2:
            return _context2.abrupt("return", axios_1.AxiosCRUD.post({
              url: this.baseURL,
              params: data
            }));
          case 3:
...
exports.Sync = Sync;
},{"../utils/axios":"src/utils/axios.ts"}],"src/Models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
var Attributes = /*#__PURE__*/function () {
  ...
  _createClass(Attributes, [{
    ...
    key: "set",
    value: function set(_props) {
      this.data = Object.assign(Object.assign({}, this.data), _props);
    }
  }]);
  return Attributes;
}();
...
var Collection = /*#__PURE__*/function () {
  function Collection(rootURL, deserializer) {
    var _this = this;
    _classCallCheck(this, Collection);
    this.fetch = function () {
      axios_1.AxiosCRUD.get({
        url: _this.rootURL,
        params: null
      }).then(function (response) {
        _this.models = response.data.map(function (user) {
          return _this.deserializer(user);
        });
        _this.trigget("change");
      });
    };
...
},{"../utils/axios":"src/utils/axios.ts","./Eventing":"src/Models/Eventing.ts"}],"src/Models/User.ts":[function(require,module,exports) {
"use strict";
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  _createClass(User, null, [{
    ...
    value: function BuildUser(attrs) {
      return new Model_1.Model(new Eventing_1.Eventing(), new Sync_1.Sync("http://localhost:3000/users"), new Attributes_1.Attributes(attrs));
    }
  }, {
    key: "BuildCollection",
    value: function BuildCollection() {
...
exports.User = User;
},{"./Model":"src/Models/Model.ts","./Eventing":"src/Models/Eventing.ts","./Sync":"src/Models/Sync.ts","./Attributes":"src/Models/Attributes.ts","./Collection":"src/Models/Collection.ts"}],"src/Views/View.ts":[function(require,module,exports) {
"use strict";
...
var View = /*#__PURE__*/function () {
  function View(parent, model) {
    ...
    this.render = function () {
      ...
      _this.eventBinder(template.content);
      if (_this.parent) {
  ...
  _createClass(View, [{
    ...
    value: function mapRegions(fragment) {
      var _this2 = this;
      var regionsObj = this.regionsMap();
      Object.keys(regionsObj).forEach(function (regionKey) {
        _this2.regions[regionKey] = fragment.querySelector(regionsObj[regionKey]);
      });
    }
  }, {
    key: "eventBinder",
    value: function eventBinder(fragment) {
      var events = this.eventMap();
      Object.keys(events).forEach(function (eventKey) {
        var element = eventKey.split(":")[0];
        var DOMEvent = eventKey.split(":")[1];
        fragment.querySelectorAll(element).forEach(function (element) {
          element.addEventListener(DOMEvent, function (e) {
            e.preventDefault();
            events[eventKey]();
          });
        });
...
var UserShow = /*#__PURE__*/function (_View_1$View) {
  ...
  _createClass(UserShow, [{
    ...
    value: function template() {
      return "\n            <div>\n                <h1>User Details</h1>\n                <div>\n                    <label>user name: ".concat(this.model.get("name"), " </label>\n                </div>\n                <div>\n                    <label>user age: ").concat(this.model.get("age"), "</label>\n                </div>\n            </div>\n        ");
    }
  }]);
  return UserShow;
}(View_1.View);
...
var UserForm = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserForm() {
    ...
    _this.changeName = function () {
      var _a;
      var _name = ((_a = document.querySelector("#name_input")) === null || _a === void 0 ? void 0 : _a.value) || "";
      _this.model.set({
        name: _name
      });
    };
...
},{"./UserShow":"src/Views/UserShow.ts","./View":"src/Views/View.ts","./UserForm":"src/Views/UserForm.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var userForm = new UserEdit_1.UserEdit(document.querySelector("#parent"), user);
userForm.render();
